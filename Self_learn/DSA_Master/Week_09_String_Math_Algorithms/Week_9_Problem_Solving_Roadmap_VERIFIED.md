# Week 9: Problem-Solving Roadmap & Decision Trees
...
├─ Pattern with wildcards? → Regex/other approach
...
**Key Insight:** Binary exp via bit-by-bit processing
...
| Line intersection | Cross prod | O(1) per pair | Segment tests |
